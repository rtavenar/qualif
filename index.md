...
- Diplôme d'ingénieur &amp; Master Recherche, Université de Lyon / École Centrale de Lyon (Lyon, France, 2006)
  ...
  - Master Recherche en "Informatique Graphique et Image"
...
- Directeur adjoint du département MIASHS (Statistiques - Informatique), Université de Rennes 2 (2014 - 2019)
  - Directeur par interim entre Septembre 2017 et Janvier 2018
- Coordinateur C2i puis Pix, Université de Rennes 2 (2014 - 2020)
  - En charge de la certification Pix (anciennement C2i) pour l'Université
- Responsable de la première année du parcours Sciences des Données du master Mathématiques Appliquées, Statistiques, Université de Rennes 2 (depuis 2020)
- Justificatif **TODO Johan**
...
- Stagiaires de Master 2
  ...
  - Anh N'Guyen (2014)
    ...
    - co-encadré avec Prof. Laetitia Chapel
...
- Apprentissage Statistique pour les Séries Temporelles Environnementales (MATS, 2019 - 2023)
  ...
  - Porteur du projet
  - [[justificatif](https://anr.fr/Projet-ANR-18-CE23-0006)]
...
Ces travaux m'ont amené à créer une librairie python d'apprentissage à partir de séries temporelles  (`tslearn`, voir plus bas) qui est utilisée à la fois par des chercheurs de ma communauté et des acteurs de divers domaines applicatifs {% cite tslearn %}.
